            ...
            <div className='causes maxwidth500 mb-sm-50 dashboard-card-wrapper'>
              <div className='thumb'>
                <div className='dashboard-card-container' style={{ background: 'none #FFFFFF' }}>
                  <img className='img-thumbnail bg-black' alt='create new project' src='img/newProjectThumbnail.png' />
        ...
        <div className='col-sm-12 col-md-12 col-lg-3 animation-1 mt-4'>
          <Link href='/dashboard/market'>
            <div className='causes maxwidth500 mb-sm-50 dashboard-card-wrapper'>
              <div className='thumb'>
                <div className='dashboard-card-container' style={{ background: 'none #FFFFFF' }}>
                  <img className='img-thumbnail bg-black' alt='supply market' src='img/marketThumbnail.png' />
